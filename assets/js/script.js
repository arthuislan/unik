(function () {
  const translations = {
    en: {
      ...
      'service.airbnb.title': 'Limpieza para Airbnb',
      'service.organizer.title': 'Organización del Hogar & Personal Organizer',
    ...
    es: {
      ...
      'service.airbnb.title': 'Limpeza para Airbnb',
      'service.organizer.title': 'Organização Residencial & Personal Organizer',
    ...
    pt: {
      ...
      'service.airbnb.title': 'Airbnb Cleaner',
      'service.organizer.title': 'Home Organization & Personal Organizer',
